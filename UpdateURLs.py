...
__version__ = "0.1"
__license__ = "GPL"
__description__ = "This Python script accepts three arguments; a given directory, text to search for, and the text replacement and will recusively go through every HTML,  HTM, PY and PHP, RB file in the given directory and subdirectory and replace the search text with the given replacement text. "
